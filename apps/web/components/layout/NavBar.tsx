...
export function NavBar() {
  ...
  return (
    <aside className="app-rail flex border-b border-border bg-bg p-3 lg:flex-col lg:gap-5 lg:border-b-0 lg:border-r lg:px-3.5 lg:py-[18px]">
      <div className="flex items-center gap-2.5 px-2 lg:w-full">
        <span className="flex h-[26px] w-[26px] items-center justify-center rounded-md bg-gradient-to-br from-cyan to-blue text-sm font-extrabold text-bg">S</span>
